    ...
    this.bestaetigen = () => {
        $http
            ...
            .then(response => {
                ...
                this.lon = response.data.Response.View[0].Result[0].Location.Address.HouseNumber;
                this.lat = response.data.Response.View[0].Result[0].Location.DisplayPosition.HouseNumber;
